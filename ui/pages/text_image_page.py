...
_MODE_HINTS = {
    ...
    "poster": "模型生成背景，中文文案由本地排版器精确叠加——文字不会出错。",
...
class TextImagePage(QWidget):
    def __init__(self, parent: "QWidget | None" = None) -> None:
        ...
        self.text_style_row = QWidget()
        text_style_layout = QHBoxLayout(self.text_style_row)
        ...
        text_style_layout.addWidget(QLabel("本地文字风格"))
        text_style_layout.addWidget(self.t2i_text_style)
        text_style_layout.addStretch(1)
        copy_layout.addWidget(self.text_style_row)
    ...
    def sync_text_image_mode(self) -> None:
        ...
        self.t2i_copy_box.setVisible(poster_mode)
        self.text_style_row.setVisible(mode == "poster")
    ...
    def on_validation_error(self) -> None:
        ...
        copy_missing = mode in {"poster", "full_poster"} and not self.t2i_copy.toPlainText().strip()
